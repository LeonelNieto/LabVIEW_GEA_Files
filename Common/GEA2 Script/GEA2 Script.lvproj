	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="LabVIEW_GEA2_Toolkit.lvlibp" Type="LVLibp" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp">
			<Item Name="advanced" Type="Folder">
				...
				<Item Name="GEA2 Message Received Event Handler.vi" Type="VI" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/advanced/GEA2 Message Received Event Handler.vi"/>
				<Item Name="GEA2 Message Sent Event Handler.vi" Type="VI" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/advanced/GEA2 Message Sent Event Handler.vi"/>
			...
			<Item Name="subVIs" Type="Folder">
				...
				<Item Name="Format Message New to Old.vi" Type="VI" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/subVIs/Format Message New to Old.vi"/>
				<Item Name="GEA2 Board ID to Board Index.vi" Type="VI" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/subVIs/GEA2 Board ID to Board Index.vi"/>
				...
				<Item Name="Message to Byte Array.vi" Type="VI" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/subVIs/Message to Byte Array.vi"/>
				<Item Name="Message Type Conversion.vi" Type="VI" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/subVIs/Message Type Conversion.vi"/>
			...
			<Item Name="type defs" Type="Folder">
				...
				<Item Name="Data Type.ctl" Type="VI" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/type defs/Data Type.ctl"/>
			...
			<Item Name="GEA2_Controls.mnu" Type="Document" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/GEA2_Controls.mnu"/>
			<Item Name="GEA2_Functions.mnu" Type="Document" URL="../../LabVIEW GEA2 Toolkit/LabVIEW_GEA2_Toolkit.lvlibp/GEA2_Functions.mnu"/>
